...
//	u16 temp; 
		...
		switch(dir)
		{
		  ...
		  LCD_WriteReg(0x36,regval|0x0A);//改变扫描方向命令  ---此处需要查看数据手册，确定RGB颜色交换位的配置
...
void LCD_Color_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 *color)//注意color是一个u16的指针
{  
	u16 height,width;
	u16 i,j;
